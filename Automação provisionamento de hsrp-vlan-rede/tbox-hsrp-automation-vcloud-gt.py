...
vlanlivre = False
mynetpool = ['10.137.160.0/20']

username = 'nomedousuario'
password = getpass('Type {} password:\n'.format(username))
rede = input("Digite a rede da interface vlan (exemplo 10.137.160.0/27 ou 10.137.160.0 255.255.255.0):\n")
...
outputag1 = instancia1.send_command('sh ip route 10.137.160.0/20 longer-prefixes direct | exclude via')
